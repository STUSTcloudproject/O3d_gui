...
if __name__ == "__main__":
    ...
    parser.add_argument("--width",
                         type=int,
                         default=640,
                         help="Set the width of the video stream")
    parser.add_argument("--height", 
                        type=int, 
                        default=480,
                        help="Set the height of the video stream")
    ...
    if args.record_imgs or args.record_rosbag:
        ...
        config.enable_stream(rs.stream.depth, video_config["width"], video_config["height"], fmt, video_config["fps"])
        w, h, fps, fmt = color_profiles[0]
        config.enable_stream(rs.stream.color, video_config["width"], video_config["height"], fmt, video_config["fps"])
